/**
 * PRISMA RT 04 — Neon Postgres Real-Time DDL Migration & Seeder
 * Creates tables for User, Warga, Pengurus, Surat, Keuangan, LaporanKeamanan, AuthCode, AuditLog
 */
...
async function runMigration() {
  console.log("🚀 Starting Neon Postgres Table Creation for PRISMA RT 04...\n");
  ...
  try {
    ...
    `;
    console.log("✓ Table 'Pengurus' created");
    ...
    `;
    console.log("✓ Table 'Surat' created");
    ...
    `;
    console.log("✓ Table 'Keuangan' created");

    // 7. LaporanKeamanan Table
    await sql`
    ...
    `;
    console.log("✓ Table 'LaporanKeamanan' created");
    ...
    `;
    console.log("✓ Table 'AuthCode' created");
    ...
    // 11. Seed Admin & Pengurus into User & Warga
    ...
    console.log("✓ Initial Admin & Pengurus accounts created");
    console.log("\n🎉 ALL PRISMA RT 04 TABLES AND DATA SUCCESSFULLY DEPLOYED TO NEON POSTGRES!");
  } catch (err) {
